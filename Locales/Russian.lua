...
L["XP_DISABLED_DETECTED"] = "Получение опыта отключено. Корректировка Quest XP приостановлена."
L["XP_DISABLED_CHANGED"] = "Получение опыта было отключено. Корректировка Quest XP приостановлена."
L["XP_ENABLED_CHANGED"] = "Получение опыта было включено. Корректировка Quest XP возобновлена."